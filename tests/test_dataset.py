...
def orders_dataset(order_data, customers_dataset):
    return Dataset(
        ...
        relationships={
            "customer_id": customers_dataset["id"]
        }
    )
...
def test_dataset_validate_invalid_data():
    invalid_data = [{"id": "not_an_int", "name": "John", "age": 25, "gender": "Male"}]  # id should be int
    dataset = Dataset(
